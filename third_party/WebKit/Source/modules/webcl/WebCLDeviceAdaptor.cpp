...
template<>
HeapVector<Member<WebCLDevice>> toMemberNativeArray<WebCLDevice, V8WebCLDevice>(v8::Local<v8::Value> value, int argumentIndex, v8::Isolate* isolate, ExceptionState& exceptionState)
{
    HeapVector<Member<WebCLDeviceAdaptor>> deviceAdaptors = toMemberNativeArray<WebCLDeviceAdaptor, V8WebCLDevice>(value, argumentIndex, isolate, exceptionState);
