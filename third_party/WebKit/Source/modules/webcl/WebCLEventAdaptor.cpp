...
template<>
HeapVector<Member<WebCLEvent>> toMemberNativeArray<WebCLEvent, V8WebCLEvent>(v8::Local<v8::Value> value, int argumentIndex, v8::Isolate* isolate, ExceptionState& exceptionState)
{
    HeapVector<Member<WebCLEventAdaptor>> eventAdaptors = toMemberNativeArray<WebCLEventAdaptor, V8WebCLEvent>(value, argumentIndex, isolate, exceptionState);
